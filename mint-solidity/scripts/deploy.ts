...
async function main() {
  ...
  const nftMint = await NftMint.deploy(params[0],params[1],params[2]);
  ...
  console.log("npx hardhat verify --network goerli --constructor-args scripts/arguments.ts " + nftMint.address)
}
